...
<button class="btn btn-dark" type="button" onclick="addForm()">Add Occasion</button>&nbsp&nbsp
<button class="btn btn-dark" type="button" onclick="deleteForm()">Delete Occasion</button>
</div>

<div style="padding:20px">
<form action="OccasionServlet" method="post" id="add" style="visibility:hidden;">
<div class="form-group">
<label>Occasion:</label><br>
<input class="form-control" type="text" name="occasion"><br>
</div>
...
<form action="OccasionServlet" method="post" id="delete" style="visibility:hidden;">
<h3>Occasion:</h3><br>
...
<tr>
<td><%= o.getOccasion() %></td>
<td><a href="/CakeStore/OccasionServlet?id=<%= o.getId() %>">Delete</a></td>
</tr>			 
<%
}
%>
